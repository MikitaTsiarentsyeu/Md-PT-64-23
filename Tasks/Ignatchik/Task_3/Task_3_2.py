...
def sum_of_even_numbers_1(enter):
    return sum(list(filter(lambda x: x % 2 == 0, enter)))
result = sum_of_even_numbers_1(input_list)
print(result)

def sum_of_even_numbers_2(enter):
    count = 0
    for i in enter:
        if i % 2 == 0:
            count += i
    return count
result = sum_of_even_numbers_2(input_list)
print(result)